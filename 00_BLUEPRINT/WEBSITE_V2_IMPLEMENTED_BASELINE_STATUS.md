# Website V2 Implemented Baseline Status
...
The homepage is no longer open for general redesign. Future changes require
...
The established hero and article reading shells remain the implementation
authority for finished core pages.
